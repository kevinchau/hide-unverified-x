...
<p align="center">
  <a href="https://github.com/kevinchau/hide-unverified-x/releases/latest"><img src="https://img.shields.io/badge/version-1.7.14-1d9bf0.svg" alt="Version 1.7.14" /></a>
...
Click **Install for Firefox** above, or [download the signed add-on from the latest release](https://github.com/kevinchau/hide-unverified-x/releases/latest) (`hide-unverified-x-1.7.14.xpi`).

1. Open the link in **Firefox**.
2. Confirm the install prompt if one appears.
3. If Firefox only downloads the file: open **Add-ons and themes** → gear icon → **Install Add-on From File…** → select `hide-unverified-x-1.7.14.xpi`.
